...
- [Test visibility setup](https://docs.datadoghq.com/tests/setup/python/?tab=cloudciprovideragentless)
- [Test impact analysis setup](https://docs.datadoghq.com/tests/test_impact_analysis/setup/python/?tab=cloudciprovideragentless) (test visibility setup is required before setting up test impact analysis)

## Upgrade from ddtrace

If you used [test visibility for Python](https://docs.datadoghq.com/tests/setup/python/) with [ddtrace](https://github.com/datadog/dd-trace-py), check out our [upgrade guide](/docs/UpgradeGuide.md).
