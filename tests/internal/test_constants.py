...
class TestConstants:
    ...
    def test_all_constants_have_unique_values(self):
        ...
        assert len(all_constants) == len(set(all_constants)), f"Constants have duplicate values: {all_constants}"
    ...
    def test_all_module_constants_are_covered(self):
        ...
        module_constants = [name for name in dir(constants_module) if name.isupper() and not name.startswith("_")]
