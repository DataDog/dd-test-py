...
import pytest
from ddtestopt.internal.logging import setup_logging, catch_and_log_exceptions, ddtestopt_logger
...
class TestCatchAndLogExceptions:
    ...
    def test_decorator_preserves_function_metadata(self, mock_exception):
        ...
        decorated()
        assert decorated.__name__ == "wrapper"  # functools.wraps preserves name in wrapper
